...
path_pairs = [
    (f"{base_in}/over_gau_0.1",
     f"{base_in}/under_gau_0.1",
     f"{base_out}/over_gau_0.1_deno",
     f"{base_out}/under_gau_0.1_deno"),
    
    (f"{base_in}/over_gau_0.2",
     f"{base_in}/under_gau_0.2",
     f"{base_out}/over_gau_0.2_deno",
     f"{base_out}/under_gau_0.2_deno"),
    
    (f"{base_in}/over_gau_0.05",
     f"{base_in}/under_gau_0.05",
     f"{base_out}/over_gau_0.05_deno",
     f"{base_out}/under_gau_0.05_deno"),

    (f"{base_in}/over_impulse_0.02",
     f"{base_in}/under_impulse_0.02",
     f"{base_out}/over_impulse_0.02_deno",
     f"{base_out}/under_impulse_0.02_deno"), 
    
    (f"{base_in}/over_impulse_0.04",
     f"{base_in}/under_impulse_0.04",
     f"{base_out}/over_impulse_0.04_deno",
     f"{base_out}/under_impulse_0.04_deno"),

    (f"{base_in}/over_poisson",
     f"{base_in}/under_poisson",
     f"{base_out}/over_poisson_deno",
     f"{base_out}/under_poisson_deno"), 


    (f"{base_in}/over_ray_0.2",
     f"{base_in}/under_ray_0.2",
     f"{base_out}/over_ray_0.2_deno",
     f"{base_out}/under_ray_0.2_deno"),

    (f"{base_in}/over_uni",
     f"{base_in}/under_uni",
     f"{base_out}/over_uni_deno",
     f"{base_out}/under_uni_deno"), 


    # todo 组合噪声
    (f"{base_in}/over_gau_0.1_poisson",
     f"{base_in}/under_gau_0.1_poisson",
     f"{base_out}/over_gau_0.1_poisson_deno",
     f"{base_out}/under_gau_0.1_poisson_deno"),
    
    (f"{base_in}/over_gau_0.1_uni",
     f"{base_in}/under_gau_0.1_uni",
     f"{base_out}/over_gau_0.1_uni_deno",
     f"{base_out}/under_gau_0.1_uni_deno"),

    (f"{base_in}/over_impulse_0.04_ray_0.2",
     f"{base_in}/under_impulse_0.04_ray_0.2",
     f"{base_out}/over_impulse_0.04_ray_0.2_deno",
     f"{base_out}/under_impulse_0.04_ray_0.2_deno"),

    (f"{base_in}/over_ray_0.2_uni",
     f"{base_in}/under_ray_0.2_uni",
     f"{base_out}/over_ray_0.2_uni_deno",
     f"{base_out}/under_ray_0.2_uni_deno"),
