...
path_pairs = [
    (f"{base_in}/source_1_gau_0.1",
     f"{base_in}/source_2_gau_0.1",
     f"{base_out}/source_1_gau_0.1_deno",
     f"{base_out}/source_2_gau_0.1_deno"),
    
    (f"{base_in}/source_1_gau_0.2",
     f"{base_in}/source_2_gau_0.2",
     f"{base_out}/source_1_gau_0.2_deno",
     f"{base_out}/source_2_gau_0.2_deno"),
    
    (f"{base_in}/source_1_gau_0.05",
     f"{base_in}/source_2_gau_0.05",
     f"{base_out}/source_1_gau_0.05_deno",
     f"{base_out}/source_2_gau_0.05_deno"),

    (f"{base_in}/source_1_impulse_0.02",
     f"{base_in}/source_2_impulse_0.02",
     f"{base_out}/source_1_impulse_0.02_deno",
     f"{base_out}/source_2_impulse_0.02_deno"), 
    
    (f"{base_in}/source_1_impulse_0.04",
     f"{base_in}/source_2_impulse_0.04",
     f"{base_out}/source_1_impulse_0.04_deno",
     f"{base_out}/source_2_impulse_0.04_deno"),
    
    (f"{base_in}/source_1_poisson",
     f"{base_in}/source_2_poisson",
     f"{base_out}/source_1_poisson_deno",
     f"{base_out}/source_2_poisson_deno"), 


    (f"{base_in}/source_1_ray_0.2",
     f"{base_in}/source_2_ray_0.2",
     f"{base_out}/source_1_ray_0.2_deno",
     f"{base_out}/source_2_ray_0.2_deno"),

    (f"{base_in}/source_1_uni",
     f"{base_in}/source_2_uni",
     f"{base_out}/source_1_uni_deno",
     f"{base_out}/source_2_uni_deno"), 


    # todo 组合噪声
    (f"{base_in}/source_1_gau_0.1_poisson",
     f"{base_in}/source_2_gau_0.1_poisson",
     f"{base_out}/source_1_gau_0.1_poisson_deno",
     f"{base_out}/source_2_gau_0.1_poisson_deno"),
    
    (f"{base_in}/source_1_gau_0.1_uni",
     f"{base_in}/source_2_gau_0.1_uni",
     f"{base_out}/source_1_gau_0.1_uni_deno",
     f"{base_out}/source_2_gau_0.1_uni_deno"),

    (f"{base_in}/source_1_impulse_0.04_ray_0.2",
     f"{base_in}/source_2_impulse_0.04_ray_0.2",
     f"{base_out}/source_1_impulse_0.04_ray_0.2_deno",
     f"{base_out}/source_2_impulse_0.04_ray_0.2_deno"),

    (f"{base_in}/source_1_ray_0.2_uni",
     f"{base_in}/source_2_ray_0.2_uni",
     f"{base_out}/source_1_ray_0.2_uni_deno",
     f"{base_out}/source_2_ray_0.2_uni_deno"),
    ...
    def sample_sequence(self, model, cls_fn=None):
        ...
        for source_path1, source_path2, output_path1, output_path2 in path_pairs:
            ...
            for x_orig_A, x_orig_B, classes, save_name in pbar: 
                ...
                # print("----------------------------save_name = ", save_name,"----input_sigma = ", input_sigma)
