...
def fuse(): 
    ...
    datasets = ['Roadscene-adaptive-pixel']

    dataset = 'roadscene-adaptive-pixel'
    method = 'NA-MMIF'
    ...
    path_pairs = [
        (f"{base_out}/{method}_gau_0.1/",
         f"{base_in}/vi_gau_0.1_deno/",
         f"{base_in}/ir_gau_0.1_deno/"),
        
        (f"{base_out}/{method}_gau_0.2/",
         f"{base_in}/vi_gau_0.2_deno/",
         f"{base_in}/ir_gau_0.2_deno/"),
        
        (f"{base_out}/{method}_gau_0.05/",
         f"{base_in}/vi_gau_0.05_deno/",
         f"{base_in}/ir_gau_0.05_deno/"),
        
        (f"{base_out}/{method}_impulse_0.02/",
         f"{base_in}/vi_impulse_0.02_deno/",
         f"{base_in}/ir_impulse_0.02_deno/"),
        
        (f"{base_out}/{method}_impulse_0.04/",
         f"{base_in}/vi_impulse_0.04_deno/",
         f"{base_in}/ir_impulse_0.04_deno/"),

        (f"{base_out}/{method}_poisson/",
         f"{base_in}/vi_poisson_deno/",
         f"{base_in}/ir_poisson_deno/"),

        (f"{base_out}/{method}_ray_0.2/",
        f"{base_in}/vi_ray_0.2_deno/",
        f"{base_in}/ir_ray_0.2_deno/"),

        (f"{base_out}/{method}_uni/",
         f"{base_in}/vi_uni_deno/",
         f"{base_in}/ir_uni_deno/"),
        
        # todo 组合噪声
        (f"{base_out}/{method}_gau_0.1_poisson/",
         f"{base_in}/vi_gau_0.1_poisson_deno/",
         f"{base_in}/ir_gau_0.1_poisson_deno/"),
        
        (f"{base_out}/{method}_gau_0.1_uni/",
         f"{base_in}/vi_gau_0.1_uni_deno/",
         f"{base_in}/ir_gau_0.1_uni_deno/"),
        

        (f"{base_out}/{method}_impulse_0.04_ray_0.2/",
         f"{base_in}/vi_impulse_0.04_ray_0.2_deno/",
         f"{base_in}/ir_impulse_0.04_ray_0.2_deno/"),
        
        (f"{base_out}/{method}_ray_0.2_uni/",
         f"{base_in}/vi_ray_0.2_uni_deno/",
         f"{base_in}/ir_ray_0.2_uni_deno/"),
    ]
